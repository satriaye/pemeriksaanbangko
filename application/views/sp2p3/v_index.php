	...
	<div class="col-lg-12">
		<div class="card mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color:#e6ffff">
				<h6 class="m-0 font-weight-bold text-primary">Tabel Data SP2 P3</h6>
				<div class="btn-group">
					<!--<a href="<?= base_url("sp2p3/tambah") ?>" class="m-0 float-right btn btn-primary btn">
					...
					<a href="<?= base_url("sp2p3/exportlistsp2p3") ?>"
			...
			<div class="table-responsive p-3">
				...
				&nbsp;&nbsp;&nbsp;<a href="<?= base_url("sp2p3/filter/Perlengkapan_Berkas_&_Generate_NP2") ?>" class="m-0 float-right btn btn-primary btn-sm">Tunggakan NP2</a>&nbsp;&nbsp;&nbsp;
				<a href="<?= base_url("sp2p3/filter/SP2_terbit") ?>" class="m-0 float-right btn btn-warning btn-sm">Tunggakan SP2</a>&nbsp;&nbsp;&nbsp;
				<a href="<?= base_url("sp2p3/filter/LHP_terbit") ?>" class="m-0 float-right btn btn-success btn-sm">LHP Terbit</a>&nbsp;&nbsp;&nbsp;
			
				
					<div class="btn-group-mb-1">
						<a href="<?= base_url('sp2p3') ?>"><i class="fa fa-history"></i></a>
					</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<table class="table align-items-center table-flush table-hover" id="dataTableHover">
					...
					<tbody>
						<?php $no=1; foreach($listsp2p3 as $value): ?>
						<tr>
							...
							<td>
								<div class="btn-group dropleft">
									<a type="button" href="<?= base_url('datapemrikp3/exportpdf/'. $value->id_datapemrikp3)?>" target="_blank" class="btn btn-warning btn-sm" aria-haspopup="true"
										aria-expanded="false">
										<i class="fa fa-cat"></i>
									</a>
								</div>
							...
							<td style="font-size: 12px; color:#800060"><?= $value->t_tanggalupdatesp2p3 ?></td>
							<td>
              <div class="btn-group dropleft">
									...
									<div class="dropdown-menu">
										<a type="button" href="<?= base_url('sp2p3/edit/' . $value->id_datapemrikp3)?>"
...
<script type="text/javascript">
	function deletesp2p3(id_datapemrikp3, t_namawp) {
		...
		swal({
			...
			if (submit) {
				$.ajax({
					url: "<?= base_url('sp2p3/delete/') ?>" + id_datapemrikp3,
					type: 'delete',
	...
	function filterData() {
		...
		window.location.href = "<?= base_url('sp2p3/filter/') ?>" + status ;
	...
	//Export PDF
	function exportsp2p3() {
		var id_datapemrikp3 = $('#id_datapemrikp3').val();
		window.open("<?= base_url('sp2p3/exportpdf/')?>");
