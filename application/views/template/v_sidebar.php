...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>" style="background-color:#2335a9">
      ...
      <li class="nav-item" style="background-color:	#ffe6f3">
        <a class="nav-link" href="<?= base_url('logbookkerja') ?>"><i class="fas fa-fw fa-table" ></i>
          <span >Notes Kerja</span>
        </a>
      </li>

      <li class="nav-item" style="background-color:#e6e6ff" >
        ...
        <div id="admpemeriksaanfpp" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('sp2fpp') ?>">SP2 </a>
            <a class="collapse-item" href="<?= base_url('monitoringlhpfpp') ?>" style="font-size: 13px">Monitoring LHP Selesai</a>
            <a class="collapse-item" href="<?= base_url('skpfpp') ?>" style="font-size: 13px">SKP</a>
          </div>
        </div>
      </li>


    <!--  <li class="nav-item" style="background-color:#e6ffff">
        ...
        <div id="admpemeriksaanp3" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('skpp3') ?>" style="font-size: 13px">SKP P3</a>
          </div>
        </div>
      </li>-->
     ...
     <!-- <li class="nav-item">
      ...
      <li class="nav-item" style="background-color:#e6ffff">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBahanPaparan" aria-expanded="true"
          aria-controls="collapseBahanPaparan" style="background-color:#e6ffff">
          <i class="fas fa-fw fa-palette"></i>
          <span>Isi Data</span>
        </a>
        <div id="collapseBahanPaparan" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="background-color:#e6ffff">Isi Data</h6>
     ...
     <!-- <li class="nav-item">
      ...
      <li class="nav-item" style="background-color:#f3ffe6">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBerkasPemeriksaan" aria-expanded="true"
          aria-controls="collapseBahanPaparan" style="background-color:#f3ffe6">
          <i class="fas fa-fw fa-book"></i>
          <span>Berkas Pemeriksaan</span>
        </a>
        <div id="collapseBerkasPemeriksaan" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header" style="background-color:#f3ffe6">Berkas Pemeriksaan</h6>
            <a class="collapse-item" href="<?= base_url('berkaskinerjapemeriksaan') ?>">Kinerja Pemeriksaan</a>
            <a class="collapse-item" href="<?= base_url('berkaspemeriksaan') ?>">Berkas LHP</a>
          </div>
        </div>
      </li>
    </ul>
