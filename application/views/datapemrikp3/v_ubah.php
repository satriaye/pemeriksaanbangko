			...
			<input type="hidden" id="id_datapemrikp3" value="<?= $datadatapemrikp3->id_datapemrikp3 ?>">
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						value="<?= $datadatapemrikp3-> t_namawp?>">
					</div>
				</div>
				<div class="form-group row">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						...
						value="<?= $datadatapemrikp3-> t_alamatsurat?>">
					</div>
				</div>
                <div class="form-group row">
					...
					<div class="col-sm-9">
						...
						value="<?= $datadatapemrikp3-> t_masa_tahun_pajak?>">
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-9">
						...
						value="<?= $datadatapemrikp3-> t_jenispemeriksaan?>">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-9">
						...
						value="<?= $datadatapemrikp3-> t_kodepemeriksaan?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" class="col-sm-3 col-form-label">Potensi KKA</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" maxlength="20" placeholder="pakai angka tanpa titik atau koma"
							style="color: #1a1a1a; background-color:#99ffb3" id="potensikka"
							value="<?= $datadatapemrikp3-> t_potensikka?>">
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" maxlength="20" placeholder="Nama AR"
							style="color: #1a1a1a; background-color:#ccffd9" id="ar" value="<?= $datadatapemrikp3-> t_ar?>">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					<label for="inputPassword3" style="color:#284d00" class="col-sm-3 col-form-label"><b>NP2</b></label>
					<div class="col-sm-9">
						<input type="text" class="form-control" placeholder="1234567890" style="color: #1a1a1a; background-color:#e6ffcc" id="np2"
						value="<?= $datadatapemrikp3-> t_np2?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="inputPassword3" style="color:#284d00" class="col-sm-3 col-form-label"><b>Tanggal NP2</b></label>
					<div class="col-sm-9">
						<input type="date" class="form-control"  style="color: #1a1a1a; background-color:#e6ffcc" id="tanggalnp2"
						value="<?= $datadatapemrikp3-> t_tanggalnp2?>">
					</div>
				</div>
				<div class="form-group row">
...
function submit_update()
{
	...
	{
		$.ajax({
			url: "<?= base_url('datapemrikp3/update/' . $datadatapemrikp3->id_datapemrikp3) ?>",
			type: 'post',
			data: {
				namawp: namawp,
				npwp: npwp,
