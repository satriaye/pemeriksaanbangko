		...
		<div class="row">
			...
			<div>
					...
					<tr>
						<td>&nbsp;&nbsp;&nbsp;Kepada Saudara yang namanya tersebut dibawah ini:
							...
							<table align="left" width='90%'>
								<tr>
									<td width="35%">&nbsp;&nbsp;&nbsp;Nama</td>
									<td>: <?= $datadatapemrikp3-> t_namawp?></td>
								</tr>

								<tr>
									<td>&nbsp;&nbsp;&nbsp;NPWP</td>
									<td>: <?= $datadatapemrikp3-> t_npwp?></td>
								</tr>

								<tr>
									<td valign="top">&nbsp;&nbsp;&nbsp;Alamat</td>
									<td>: <?= $datadatapemrikp3-> t_alamatsurat?></td>
								</tr>

								<tr>
									<td>&nbsp;&nbsp;&nbsp;Masa & Tahun Pajak</td>
									<td>: <?= $datadatapemrikp3-> t_masa_tahun_pajak?></td>
								</tr>

								<tr>
									<td>&nbsp;&nbsp;&nbsp;Kode Pemeriksaan</td>
									<td>: <?= $datadatapemrikp3-> t_kodepemeriksaan?></td>
								</tr>
				...
				<p style="page-break-before: always">
					...
					<table width='50%'>
						<tr>
							<td>Yth. Direktur/ Pimpinan/ Sdr. <?= $datadatapemrikp3-> t_namawp?>
								<br>
								<?= $datadatapemrikp3-> t_alamatsurat?></td>
						</tr>
					</table>
