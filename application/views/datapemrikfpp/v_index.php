...
<div class="container-fluid" id="container-wrapper">
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Data Pemeriksaan FPP</h1>
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="./">Home</a></li>
			<li class="breadcrumb-item active" aria-current="page">Data Pemeriksaan FPP</li>
		</ol>
	</div>
	<div class="col-lg-12">
		<div class="card mb-4">
			...
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color:#e6e6ff">
				<h6 class="m-0 font-weight-bold text-primary">Tabel Data Pemeriksaan FPP</h6>
				<div class="btn-group">
					<a href="<?= base_url("datapemrikfpp/tambah") ?>" class="m-0 float-right btn btn-primary btn">
			...
			<div class="table-responsive p-3">
				...
				&nbsp;&nbsp;&nbsp;<a href="<?= base_url("datapemrikfpp/filter/Belum_terbit_NP2") ?>" class="m-0 float-right btn btn-secondary btn-sm">Belum terbit NP2</a>&nbsp;&nbsp;&nbsp;
				<a href="<?= base_url("datapemrikfpp/filter/Perlengkapan_Berkas_&_Generate_NP2") ?>" class="m-0 float-right btn btn-primary btn-sm">NP2 terbit</a>&nbsp;&nbsp;&nbsp;
				<a href="<?= base_url("datapemrikfpp/filter/SP2_terbit") ?>" class="m-0 float-right btn btn-warning btn-sm">SP2 terbit</a>&nbsp;&nbsp;&nbsp;
				<a href="<?= base_url("datapemrikfpp/filter/LHP_terbit") ?>" class="m-0 float-right btn btn-success btn-sm">LHP terbit</a>&nbsp;&nbsp;&nbsp;
			
				
					<div class="btn-group-mb-1">
						<a href="<?= base_url('datapemrikfpp') ?>"><i class="fa fa-history"></i></a>
					</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<table class="table align-items-center table-flush table-hover" id="dataTableHover">
					...
					<thead class="thead-light">
						<tr>
							...
							<th style="font-size: 12px ; background-color:#ffe6cc">Keterangan/ Progress</th>
					...
					<tbody>
						<?php $no=1; foreach($listdatapemrikfpp as $value): ?>
						<tr>
							...
							<!--<td style="font-size: 12px"><?= $value->t_tanggalinput ?></td>-->
							<!--<td>
								<div class="btn-group dropleft">
									<a type="button" href="<?= base_url('datapemrikfpp/exportpdf/'. $value->id_datapemrikfpp)?>" target="_blank" class="btn btn-primary btn-sm" aria-haspopup="true"
										aria-expanded="false">
										<i class="fa fa-cat"></i>
									</a>
								</div>
								...
								<div class="btn-group dropleft">
									<a type="button" href="<?= base_url('datapemrikfpp/exportpdf/'. $value->id_datapemrikfpp)?>" target="_blank" class="btn btn-info btn-sm" aria-haspopup="true"
										aria-expanded="false">
										<i class="fa fa-dog"></i>
									</a>
								</div>
								<div class="btn-group dropleft">
									<a type="button" href="<?= base_url('datapemrikfpp/exportpdf/'. $value->id_datapemrikfpp)?>" target="_blank" class="btn btn-success btn-sm" aria-haspopup="true"
										aria-expanded="false">
							...
							<td style="font-size: 12px"><?= $value->t_tanggalnp2?></td>
							<td style="font-size: 12px"><b><?= $value->t_sp2 ?></b></td>
							<td style="font-size: 12px"><?= $value->t_tanggalsp2 ?></td>
							<td style="font-size: 12px"><?= $value->t_jatuhtempo ?></td>
							...
							<td >
								<div class="btn-group dropleft">
									...
									<div class="dropdown-menu">
										<a type="button" href="<?= base_url('datapemrikfpp/edit/' . $value->id_datapemrikfpp)?>"
											class="dropdown-item"><i class="fa fa-edit"></i> Edit </a>
										<div class="dropdown-divider"></div>
										<a type="button"
											onclick="deletedatapemrikfpp('<?=$value->id_datapemrikfpp?>','<?=$value->t_namawp?>');"
...
<script type="text/javascript">
	function deletedatapemrikfpp(id_datapemrikfpp, t_namawp) {
		...
		swal({
			...
			if (submit) {
				$.ajax({
					url: "<?= base_url('datapemrikfpp/delete/') ?>" + id_datapemrikfpp,
					type: 'delete',
		...
		function exportlistdatapemrikfpp() {
	...
	function filterData() {
		...
		window.location.href = "<?= base_url('datapemrikfpp/filter/') ?>" + status ;
	...
	//Export PDF
	function exportdatapemrikfpp() {
		var id_datapemrikfpp = $('#id_datapemrikfpp').val();
		window.open("<?= base_url('datapemrikfpp/exportpdf/'. $value->id_datapemrikfpp)?>");
