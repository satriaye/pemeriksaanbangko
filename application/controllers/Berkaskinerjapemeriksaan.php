...
class berkaskinerjapemeriksaan extends MY_Controller 
{
...
public function tambah()
{
    ...
    $this->template->load('template/v_layout','berkaskinerjapemeriksaan/v_tambah', $data);
}        
...
public function index()
{
	...
	$this->template->load('template/v_layout','berkaskinerjapemeriksaan/v_index', $data);
}
