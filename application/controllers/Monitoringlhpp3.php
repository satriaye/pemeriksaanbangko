...
class monitoringlhpp3 extends MY_Controller 
{
...
//Login
    ...
    {
        parent::__construct();
        $this->load->model('m_monitoringlhpp3');
...
//Index
	public function index()
	{
        ...
        $data['listmonitoringlhpp3'] = $this->m_monitoringlhpp3->listmonitoringlhpp3();

		$this->template->load('template/v_layout','monitoringlhpp3/v_index', $data);
	}
...
//Filter
	...
	{
        $data['userlogin'] = $this->userlogin;
        $data['listmonitoringlhpp3'] = $this->m_monitoringlhpp3->filterlistmonitoringlhpp3($status);
...
//Tambah
    public function tambah()
	{
		...
		$this->template->load('template/v_layout','monitoringlhpp3/v_tambah', $data);
	}
...
//Simpan
    public function simpan()
	{
        ...
        if($this->m_monitoringlhpp3->insert($in_data))
        {
...
//Edit
    public function edit($id_datapemrikp3)
	{
        ...
        $data['datadatapemrikp3'] = $this->m_monitoringlhpp3->listmonitoringlhpp3_byid($id_datapemrikp3);

		$this->template->load('template/v_layout','monitoringlhpp3/v_ubah', $data);
    }
...
//Update
    public function update($id_datapemrikp3)
	{
        ...
        if($this->m_monitoringlhpp3->update($in_data, $id_data))
        {
            $output ['status_code'] = 200; //200, 400, 404, 500
            $output ['title'] = "Berhasil";
...
//Delete
    public function delete($id_datapemrikp3)
	{
        ...
        if($this->m_monitoringlhpp3->delete($id_datapemrikp3))
        {
            $output ['status_code'] = 200; //200, 400, 404, 500
            $output ['title'] = "Berhasil";
...
//Export Excel
    public function exportlistmonitoringlhpp3()
	{
        $listdata = $this->m_monitoringlhpp3->exportlistmonitoringlhpp3();
        $data = array(
            'title' => 'List Data Usulan Pemeriksaan - ' . time(),
            'listdata' => $listdata
        );
        $this->load->view('monitoringlhpp3/v_listmonitoringlhpp3_xls', $data);
...
//Export PDF
    public function exportpdf($id_datapemrikp3)
	{
        $data['userlogin'] = $this->userlogin;
        $id_data['id_datapemrikp3'] = $id_datapemrikp3;
        $data['datamonitoringlhpp3'] = $this->m_monitoringlhpp3->listmonitoringlhpp3_byid($id_datapemrikp3);
        
        $this->pdf->setPaper('A4','portrait');
        $this->pdf->filename = "Cetak ND & S.pdf";
        $this->pdf->load_view('monitoringlhpp3/v_cetakmonitoringlhpp3', $data);
	}
...
//UploadFiles (masih gagal)+
    public function uploadfiles() 
    {
        ...
        $this->load->view('template/v_layout','monitoringlhpp3/v_index', $data);

    }

//Import Dari Excel
    public function import_monitoringlhpp3()
    {
        if(isset($_FILES['file']['name']))
        {
            ...
            if($this->m_monitoringlhpp3->import_data($data))
            {
