...
class M_monitoringlhpp3 extends CI_Model
{

    private $tbl_datapemrikp3 = 'tbl_datapemrikp3';
   
    public function listmonitoringlhpp3()
    {
   ...
   // }
    ...
    public function listmonitoringlhpp3_byid($id_datapemrikp3)
    {
        return $this->db->get_where($this->tbl_datapemrikp3, ['id_datapemrikp3' => $id_datapemrikp3])->row();
    }

    //Filter ListPeminjaman
    public function filterlistmonitoringlhpp3($status)
    {
        if ($status == "semua")
        $filter = "";
        else 
