...
class M_beranda extends CI_Model
{
    ...
    private $tbl_beranda = 'tbl_beranda';
   
    public function listberanda()
    {
        return $this->db->query("SELECT * FROM tbl_beranda")->result();
    }

    public function exportlistberanda()
    {
        return $this->db->query("SELECT * FROM tbl_beranda")->result_array();
    }

    //public function listberanda()
    //{
       //return $this->db->query("SELECT d.*,b.t_masa_tahun_pajak FROM tbl_beranda d
        //JOIN tbl_berkasalket b ON b.id_berkasalket = d.id_beranda")->result();
   // }

    public function listberanda_byid($id_beranda)
    {
        return $this->db->get_where($this->tbl_beranda, ['id_beranda' => $id_beranda])->row();
    }
